CLASS zcl_s4d401_exs_handling_ss DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_S4D401_EXS_HANDLING_SS IMPLEMENTATION.
...
*        out->write( exc_auth->get_text( ) ).
        CATCH zcx_ss_failed INTO DATA(exc_ss_failed).
            out->write( exc_ss_failed->get_text( ) ).
    ENDTRY.
